        ...
        <div class="col-md-4">
            <div class="row">
                <form class="form-inline" role="form" id="objForm">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" id="tableSchema" name="tableSchema"
                               placeholder="table_schema">
                    </div>
        ...
        <div class="col-md-8">
            <form class="form-inline" role="form" id="listForm">
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                        <input type="checkbox" class="ttt" name="lf_new" value="false"/>目标new thymeleaf
                    </div>
                    <button type="button" class="btn btn-default" id="search_btn"
                            onclick="goGeneration('${ctx}/code/save', $('#listForm'))">生成
                    </button>
                </div>
