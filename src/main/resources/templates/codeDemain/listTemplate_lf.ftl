        ...
        <div class="table-responsive">
            <table id="dataTables-example" class="table table-bordered table-hover table-striped">
                ...
                <#list lists as data>
                    ...
                    <th><a class="badge badge-success" href="#" th:onclick="'javascript:createObj(&quot;' + @{/bk/mg/${CLASS_NAME_LINK}/add} +'&quot;);'">新增</a>
                    </th>
                </tr>
                </thead>
                <tbody>
...
<div id="bbar" class="row" style="background:#f5f5f5;margin-left:0px;">
    <div class="col-sm-4" style="margin-top: 13px;">
        <a class="btn btn-success btn-sm" href="#" th:onclick="'javascript:createObj(&quot;' + @{/bk/mg/${CLASS_NAME_LINK}/add} + '&quot;);'" style="width:74px;">新增</a>
    </div>
